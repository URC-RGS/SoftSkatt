...
class Control_Box:
    ...
    def math_six_motors_off_PID(self, value_joi):  
        ...
        self.value_out_pwm[0] = int((1500 + value_joi['linear_x'] * 600) + (1500 + value_joi['rotate_y'] * 500) + (1500 + value_joi['linear_z'] * 500) - 3000)
        self.value_out_pwm[1] = int((1500 + value_joi['linear_x'] * 475) - (1500 + value_joi['rotate_y'] * 500) - (1500 + value_joi['linear_z'] * 600) + 3000)
        self.value_out_pwm[2] = int(-1 * (1500 + value_joi['linear_x'] * 475) + (1500 + value_joi['rotate_y'] * 500) - (1500 + value_joi['linear_z'] * 500) + 3000)
