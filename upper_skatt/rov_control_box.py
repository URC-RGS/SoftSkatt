...
class Control_Box:
    ...
    def math_six_motors_off_PID(self, value_joi):  
            ...
            self.value_out_pwm[1] = int((1490 + value_joi['linear_x'] * 500) - (1490 + value_joi['rotate_y'] * 500) - (1490 + value_joi['linear_z'] * 500) + 3000)
            ...
            self.value_out_pwm[4] = int(1510 + value_joi['linear_y'] * 500 + (1510 + value_joi['rotate_x'] * 500) - 1500)
