...
PATH_CONFIG = '/home/rock/SoftSkatt/upper_skatt/config_control_box.json'
PATH_LOG = '/home/rock/SoftSkatt/upper_skatt/.log/'
...
class Control_Box:
    ...
    def math_six_motors_off_PID(self, value_joi):  
        ...
        if value_joi['linear_z'] > 0:
            value_joi['linear_z'] *= 1
        elif value_joi['linear_z'] < 0:
            value_joi['linear_z'] *= 1
            
            
        self.value_out_pwm[0] = int((1500 + value_joi['linear_x'] * 500) + (1500 + value_joi['rotate_y'] * 500) + (1500 + value_joi['linear_z'] * 500) - 3000)
        self.value_out_pwm[1] = int((1500 + value_joi['linear_x'] * 575) - (1500 + value_joi['rotate_y'] * 500) - (1500 + value_joi['linear_z'] * 600) + 3000)
        self.value_out_pwm[2] = int(-1 * (1500 + value_joi['linear_x'] * 575) + (1500 + value_joi['rotate_y'] * 500) - (1500 + value_joi['linear_z'] * 500) + 3000)
        ...
        #     if self.value_out_pwm[0] >= min_pwm_fix and self.value_out_pwm[0] < 1500:
        #         self.value_out_pwm[0] = min_pwm_fix
        #     elif self.value_out_pwm[0] > 1501 and self.value_out_pwm[0] <= max_pwm_fix:
        #         self.value_out_pwm[0] = max_pwm_fix
            
        #     if self.value_out_pwm[1] >= min_pwm_fix and self.value_out_pwm[1] < 1500:
        #         self.value_out_pwm[1] = min_pwm_fix
        #     elif self.value_out_pwm[1] > 1501 and self.value_out_pwm[1] <= max_pwm_fix:
        #         self.value_out_pwm[1] = max_pwm_fix
                
        #     if self.value_out_pwm[2] >= min_pwm_fix and self.value_out_pwm[2] < 1500:
        #         self.value_out_pwm[2] = min_pwm_fix
        #     elif self.value_out_pwm[2] > 1501 and self.value_out_pwm[2] <= max_pwm_fix:
        #         self.value_out_pwm[2] = max_pwm_fix
            
        #     if self.value_out_pwm[3] >= min_pwm_fix and self.value_out_pwm[3] < 1500:
        #         self.value_out_pwm[3] = min_pwm_fix
        #     elif self.value_out_pwm[3] > 1501 and self.value_out_pwm[3] <= max_pwm_fix:
        #         self.value_out_pwm[3] = max_pwm_fix
